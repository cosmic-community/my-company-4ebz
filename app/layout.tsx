...
export const metadata: Metadata = {
  ...
  description: '40 Years of Legal Legacy, Digitally Integrated. Premium legal tech and digital estate services for international clients.',
}
...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      ...
      <body className="bg-charcoal text-gray-200">
        <Header />
